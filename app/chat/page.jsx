        ...
        <div className='p-16 sm:p-32 text-center '>
            ...
            <section className='mt-8 '>
                <form onSubmit={handleSubmit} className='flex items-center justify-center gap-4'>
                    <input value={country} onChange={(e) => setCountry(e.target.value)} className='px-8 py-2 rounded-sm bg-gray-200 focus:outline-none ' type='text' required placeholder='Enter country to get more info.'></input>
