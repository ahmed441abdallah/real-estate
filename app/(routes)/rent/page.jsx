...
import ListingSkelton from '../sell/ListingSkelton';
import ListingItem from '../sell/ListingItem';
const RentListing = () => {
...
if (loading) {
  ...
  return (
    <div className='p-4 sm:px-32 sm:py-16'>
      <h1 className='text-xl font-bold'>Listing For<span className='text-gray-600'>Rent</span> </h1>
